...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "TrafficVision KG Day 6: YOLO + ByteTrack + vehicle counting + "
            "best-shot ANPR + optional homography/speed + violation prototypes"
        )
    )
    ...
    parser.add_argument(
        "--output",
        default="outputs/day6_bestshot_geometry.mp4",
    ...
    parser.add_argument(
        "--bestshot-dir",
        default="outputs/day6_bestshots",
    ...
    # later in the separate Python 3.12 environment on outputs/day6_bestshots.
    parser.add_argument(
        "--ocr-mode",
    ...
    parser.add_argument(
        "--events-output",
        default="outputs/day6_events.jsonl",
...
def calculate_plate_quality(
    ...
    """
    Day 6 heuristic quality score before OCR.
...
def calibrate_homography(
    ...
    window_name = "Day 6 Homography Calibration"
    ...
    payload = {
        ...
        "note": (
            "Day 6 demo calibration. Speed is an estimate unless real road dimensions "
...
def main() -> None:
        ...
        while True:
            ...
            if (
                ...
                for box, track_id, class_id, confidence in zip(
                    ...
                    # -------------------------------------------------
                    # Day 6 homography -> rough speed estimate
                    # -------------------------------------------------
                    ...
                    # -------------------------------------------------
                    # Day 6 violation prototypes using existing crossing event
                    # -------------------------------------------------
            ...
            if args.show:
                cv2.imshow("TrafficVision KG - Day 6", annotated_frame)
    ...
    print()
    print("[DONE] TrafficVision KG Day 6 finished")
